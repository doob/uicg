...
<Tabs>
  ...
  <TabItem label="Preview">
    <div class="not-content relative">
      <Sidebar menuItems={items} class="bg-slate-200 dark:bg-slate-800" />
    </div>
